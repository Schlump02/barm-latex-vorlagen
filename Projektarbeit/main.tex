...
\hypersetup{
    ...
    pdftitle={Projektarbeit},     % Add the document title here
...
\fancypagestyle{Deckblatt}{
    ...
    %\lhead{\raisebox{30pt}{\includegraphics[height=0.6cm]{db_intern.png}} \\} % use this to add a confidentiality disclaimer to the title page header. Change the png file to match your companies policy; the current file shows the disclaimer of Deutsche Bahn AG.
    %page footer
...
\include{sections/nebeninhalte/sperrvermerk}% remove this if not needed
...
\include{sections/textinhalte/ausgangssituation}
\include{sections/textinhalte/ressourcen_zeitplan}
\include{sections/textinhalte/implementierung}
\include{sections/textinhalte/projektergebnisse}
...
\include{sections/nebeninhalte/bewertungsbogen}
