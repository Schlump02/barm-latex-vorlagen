...
\addto\extrasngerman{\renewcommand\tablename{Tabelle}}
...
\tolerance=9999 % for normal hyphenation, set the value to 200
\emergencystretch=10em % remove for normal hyphenation
