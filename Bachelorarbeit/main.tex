...
\usepackage{graphicx}
\usepackage{float}
\usepackage[top=1.2cm, left=2.5cm, right=2.5cm, bottom=3cm, includeheadfoot, footskip=60pt]{geometry}
...
\newcommand{\anhangsec}[1]{
   ...
   \subsection*{A\theanhangsubsec\ #1} % Stern-Version, um die automatische Nummerierung zu unterdrücken
