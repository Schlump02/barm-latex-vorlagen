...
\begin{center}
    ...
    \begin{tabular}{|c|p{6cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Beispiel Tabelle.\footnotemark}% Die (verpflichtende) Quellenangabe zu dieser \footnotemark wird durch den \footcitetext-Befehl weiter unten gesetzt
    \label{tab:example}
    \end{table}
\end{center}
...
\begin{figure}[h]
    \begin{lstlisting}
        def hello_world():
            print("Hello, World!")
    \end{lstlisting}
    \caption{Ausschnitt aus main.py.\footnotemark}% Die (verpflichtende) Quellenangabe zu dieser \footnotemark wird durch den \footnotetext-Befehl weiter unten gesetzt
    \label{fig:meincode}
\end{figure}
