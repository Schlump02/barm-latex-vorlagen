...
Ein wörtliches Zitat sollte "[\ldots] so formatiert werden." % Für Zitate in Zitaten (einzelne Anführungszeichen): ,Zitat`
...
Wenn bei der Definition einer Abkürzung nicht der Nominativ verwendet wird, kann die deklinierte Form angeben werden: die \ac[Vereinten Nationen]{UN} % funktioniert bei der ersten Verwendung des \ac{}-Befehls
