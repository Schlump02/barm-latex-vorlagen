...
Auf \abb{logo} kann im Text verwiesen werden.% Hierfür ist die Kurzbeschriftung notwendig.
% Für Tabellen: \tab{Kurzbeschriftung}
% Für Anhänge:  \anh{1}

Ein wörtliches Zitat sollte "[\ldots] so formatiert werden."\directcite{theisen2011}
