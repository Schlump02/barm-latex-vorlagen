...
\newcommand{\listacronymname}{Abkürzungsverzeichnis}

\newcommand{\showlistofabbreviations}{
  \section*{\listacronymname}
  \addcontentsline{toc}{section}{\listacronymname}
  \begin{acronym}
    \input{sections/nebeninhalte/abkuerzungsverzeichnis_content.tex}
  \end{acronym}
  \stepcounter{verzeichnisnummer}
  \newpage
}
...
\newcommand{\subsubsubsection}[1]{%
    ...
    \paragraph*{\thesubsubsubsection\hspace{0.5em}\parbox[t]{\subsubsubsectionwidth}{#1\\ }\nopagebreak}%
}
...
\fancypagestyle{Deckblatt}{
    ...
    % \lhead{\raisebox{30pt}{\includegraphics[height=0.6cm]{db_intern.png}} \\} % Use this to add information about confidantiality to title page. Change the png file for different companies.
...
\showlistofabbreviations % Abkürzungsverzeichnis - wenn leer, auskommentieren
...
\include{sections/nebeninhalte/anhang}
